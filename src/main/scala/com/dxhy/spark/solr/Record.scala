...
object SparkIndex {
  ...
  val zkHost = "DXHY-YFEB-01:2181,DXHY-YFEB-02:2181,DXHY-YFEB-03:2181/solr"
  val defaultCollection = "test_invoice2"
  val zkClientTimeout = 20000
  val zkConnectTimeout = 1000
  //solr客户端
  val client = new CloudSolrServer(zkHost)
  ...
  def main(args: Array[String]) {  
    ...
    //初始化SparkConf  
    val conf = new SparkConf().setAppName("hdfs2solr")
    //上传运行时依赖的jar包  
